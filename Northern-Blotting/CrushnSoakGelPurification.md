...
Protocol:
--------------------------------------------------------------------------------
**Part 1: Running the polyacrylamide gel (~2 hrs)**
...
**4.** Load the samples, then run the gel at 180V for 45-60 minutes, ensuring the dye front has run off.

**5.** To visualize nucleic acid for purification, stain the gel with 1X SYBR Gold (e.g. 3 µL of 10,000X SYBRGold into 30 mL of 1X TBE Buffer) for 10 minutes.

**6.** Visualize the gel using the UV transilluminator, and use a clean razor to excise the band for purification. Measure its weight, and place the band in a 1.5 mL tube. 

**Part 2: Gel Purification Day 1**

**1.** Prepare tubes by stacking a 0.5 mL into a 1.5 mL Eppendorf. Poke a hole in the 0.5 mL with a syringe.
...
**3.** Spin at max speed at 4°C for 30 minutes. 

**4.** Remove the supernatant, and wash with 1 mL of ice cold 80% EtOH. Repellet the sample as in step 3, now spinning for only 20 minutes.

**5.** Repeat the wash step three times total. 

**6.** Remove as much of residual EtOH as possible, and spin to accumlate any EtOH at the bottom for removal.

**7.** Air-dry the pellet for 5 min at room temp

**8.** Resuspend in water, volume determined by desired final concentration. Allow to sit in water for 10 min at room temp befor epipette mixing and measuring. 
