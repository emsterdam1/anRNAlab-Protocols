...
**2.** Add 1 µl of TURBO DNase enzyme (per 50 µl reaction), mix well and incubate at room temperature for 15 minutes.<br/>
Some samples require adding the same amount of enzyme (1 µl for 50 µl reaction) halfway through the reaction.<br/>
_Note: Longer incubations at higher temps promote contaminant-dependent RNA degradation._
...
Purified RNA can be used for standard reverse transcription or [mutational profiling](../Mutational-Profiling/MaP-RT-Marathon.md).
